...
values
  ('11111111-1111-1111-1111-111111111111', 'Michael Every', 'strategist', 'high', 'Rabobank global strategist focused on macro risk, geopolitics, trade, food/agri, FX, and commodities.', 'https://www.rabobank.nl/en/knowledge/our-experts/011085368/michael-every', null),
...
values
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', '11111111-1111-1111-1111-111111111111', 'report', 'https://www.rabobank.com/knowledge', true),
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2', '11111111-1111-1111-1111-111111111111', 'blog', 'https://www.rabobank.nl/en/knowledge/our-experts/011085368/michael-every', false),
...
values
  ('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', 'Geopolitical statecraft is becoming a market driver again', 'https://example.com/signaldemo/macro-statecraft', 'report', '2026-05-02 08:40:00+08', 'Trade policy and strategic competition are becoming market drivers.', 'Trade policy, tariffs, food security, and strategic competition are moving from background risk to direct market drivers for commodities, FX, and risk assets.', 'Geopolitical statecraft can reprice gold, energy, food commodities, FX, and broad risk appetite.', 'mixed', 9.2, array['DXY','GOLD','OIL','WEAT'], array['geopolitics','macro risk','trade policy']),
  ...
  ('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', 'Food security is returning as a geopolitical risk premium', 'https://example.com/signaldemo/food-security', 'report', '2026-04-22 13:50:00+08', 'Food security risk is rising.', 'Shipping lanes, fertilizer inputs, energy costs, and state-level trade policy can keep food commodities sensitive to geopolitical shocks.', 'Food security risk maps directly to wheat, corn, sugar, energy, and inflation-sensitive trades.', 'bullish', 8.4, array['WEAT','CORN','SUGA','OIL'], array['food inflation','geopolitics','commodities']),
  ...
  ('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', 'Gold remains a hedge against policy and geopolitical disorder', 'https://example.com/signaldemo/gold-geopolitics', 'report', '2026-04-09 13:00:00+08', 'Gold remains relevant in a fragmented macro regime.', 'A more fragmented global trade and security backdrop can keep hard assets relevant even when rate expectations are noisy.', 'Gold and quality miners can benefit when policy uncertainty and geopolitical disorder stay elevated.', 'bullish', 8.7, array['GOLD','AGI','DXY'], array['gold','geopolitics','macro risk']),
